    ...
    <div className="min-h-screen bg-background text-foreground">
      <header className="sticky top-0 z-40 border-b border-border bg-card">
        <div className="mx-auto flex max-w-7xl items-center gap-4 px-5 py-2.5">
          ...
          <div className="ml-auto flex items-center gap-4"><span className="grid size-7 place-items-center bg-background font-mono text-[10px] outline outline-border">AO</span></div>
        </div>
      </header>
